...
- When X stops loading the timeline (its own rate limit), slow delete waits 5 minutes and retries, up to 3 wait rounds, before concluding the list is exhausted.
